# [Above and Beyond v1.2](https://www.curseforge.com/minecraft/modpacks/create-above-and-beyond) on Curseforge
...
The docker on first run will download the same version as tagged of `Above and Beyond v1.2` and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs and it will eventually finish.
...
* MOTD "Above and Beyond v1.2 Server Powered by Docker"
* LEVEL world
